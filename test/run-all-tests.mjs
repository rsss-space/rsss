...
const commands = [
    ...
    [
        'esbuild ./test/oauth-scopes.ts --bundle --platform=node',
        '--format=esm',
        '--external:./src/server/blurhash-runtime.js',
        '--external:stripe',
        '--alias:cloudflare:workers=./test/cloudflare-workers-stub.ts',
    ...
    [
        'esbuild ./test/oauth-credential-persistence.ts --bundle',
        '--platform=node --format=esm',
        '--external:./src/server/blurhash-runtime.js',
        '--external:stripe',
        '--alias:cloudflare:workers=./test/cloudflare-workers-stub.ts',
    ...
    [
        'esbuild ./test/dpop-proof.ts --bundle',
        '--platform=node --format=esm',
        '--external:./src/server/blurhash-runtime.js',
        '--external:stripe',
        '--alias:cloudflare:workers=./test/cloudflare-workers-stub.ts',
    ...
    [
        'esbuild ./test/oauth-token-refresh.ts --bundle',
        '--platform=node --format=esm',
        '--external:./src/server/blurhash-runtime.js',
        '--external:stripe',
        '--alias:cloudflare:workers=./test/cloudflare-workers-stub.ts',
