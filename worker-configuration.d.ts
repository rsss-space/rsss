/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0df93f930b9c8915d94fb9636747ec2a)
// Runtime types generated with workerd@1.20260521.1 2025-01-22 nodejs_compat
interface __BaseEnv_Env {
	...
	R2_BUCKET: string;
	R2_S3_API: string;
	USER_DO: DurableObjectNamespace<import("./src/server/index").RsssUserDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/index");
		durableNamespaces: "RsssUserDO";
	}
